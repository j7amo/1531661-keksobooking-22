...
const popupTitle = offerTemplate.querySelector('.popup__title');
popupTitle.textContent = generatedOffers[0].offer.title;
// 2) Выведите адрес offer.address в блок .popup__text--address.
const popupTextAddress = offerTemplate.querySelector('.popup__text--address');
...
const popupTextPrice = offerTemplate.querySelector('.popup__text--price');
...
// Дом для house
// Дворец для palace
const popupType = offerTemplate.querySelector('.popup__type');
...
const popupTextCapacity = offerTemplate.querySelector('.popup__text--capacity');
...
const popupTextTime = offerTemplate.querySelector('.popup__text--time');
...
const popupFeatures = offerTemplate.querySelector('.popup__features');
...
const popupDescription = offerTemplate.querySelector('.popup__description');
...
const popupPhotos = offerTemplate.querySelector('.popup__photos');
// тут похожая на пункт 7 история: работаем с дочерними элементами
const popupPhoto = popupPhotos.querySelector('.popup__photo');
popupPhoto.src = generatedOffers[0].offer.photos[0];
